        ...
        <tbody>
            <?php foreach ($items as $item): ?>
                <tr>
                    ...
                    <td><button type="button" class="btn btn-outline-primary"><?php echo"<a href='editar.php?id=".$item['id']."'>" ?>Editar</button>
			        </td>
			        <td><button type="button" class="btn btn-outline-danger"><?php echo"<a href='eliminar.php?id=".$item['id']."'>" ?>Eliminar</button>
			        </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
